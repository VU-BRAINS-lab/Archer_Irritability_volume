...
irritability.data<-data[,c(2:4,6,7,10,12:14,36,126:128,135,297,305:309,311,314,317,1003,1268:1335,1374,1379:1383,1386:1388,1390:1391,1396:1404)]
...
#run residualization
Y.primary <- as.matrix(irritability.data[c(25:112)])
...
main.ed.med.icv.residual <- irritability.data %>% spread_residuals(lm.tores.primary)
#condense new data frame to just sub_num, weight, and residual column
main.ed.med.icv.residual <- main.ed.med.icv.residual[c(grep("subnum_char_b|wt_NR_mwacs_b|lm.tores.primary", names(main.ed.med.icv.residual)))]
#omit cases with NAs in row
main.ed.med.icv.residual <- na.omit(main.ed.med.icv.residual)
#save csv file with sub ID, weight, and all residuals
write.csv(main.ed.med.icv.residual,"main.ed.med.icv.residual.csv", row.names = FALSE)
main.ed.med.icv.residual<-read.csv('main.ed.med.icv.residual.csv')
main.ed.med.icv.residual <-(main.ed.med.icv.residual[c(1,3:90)])

#rename
main.ed.med.icv.residual <- main.ed.med.icv.residual %>% rename("vol_1_r" = "lm.tores.primary.vol_1", 
...
main.ed.med.icv.residual<-read.csv('main.ed.med.icv.residual.csv')
main.ed.med.icv.residual<- merge(irritability.data, main.ed.med.icv.residual, by = "subnum_char_b")
main.ed.med.icv.residual <-(main.ed.med.icv.residual[c(1:112,114:201)])
# replace NA with .
main.ed.med.icv.residual[is.na(main.ed.med.icv.residual)]<-"."
write.csv(main.ed.med.icv.residual,"main.ed.med.icv.residual.csv", row.names = FALSE)
#write_csv(main.data, "irritability_new_data.csv")
write.dat(main.ed.med.icv.residual, "main.ed.med.icv.residual")